# EETEPA Analitica De Help Desk

Simulador de chamados de laboratorio, SLA, categorias de falha e metricas operacionais.

**Demo:** https://albertomateus9.github.io/eetepa-helpdesk-analytics/

## Visão Geral

EETEPA Analitica De Help Desk é uma laboratório educacional aplicado inspirado na EETEPA Vilhena Alves. O MVP foi mantido simples, executável e seguro para evoluções futuras sem depender de backend.
